...
namespace FTN.Common
{
	public class EnumDescs
	{
		...
		public EnumDescs()
		{
			//Dodavanje enmumeracija
			//Dodajem atribut za koga je ta enumeracija , bukvalno mapiram enumeraciju

			property2enumType.Add(ModelCode.REGULATINGCONTROL_MODE, typeof(RegulatingControlModeKind));
			property2enumType.Add(ModelCode.REGULATINGCONTROL_MONPHASE, typeof(PhaseCode));
			property2enumType.Add(ModelCode.BASICINTERVALSCHED_VAL1MUL, typeof(UnitMultiplier));
			property2enumType.Add(ModelCode.BASICINTERVALSCHED_VAL2MUL, typeof(UnitMultiplier));
			property2enumType.Add(ModelCode.BASICINTERVALSCHED_VAL1UNIT, typeof(UnitSymbol));
			property2enumType.Add(ModelCode.BASICINTERVALSCHED_VAL2UNIT, typeof(UnitSymbol));
			property2enumType.Add(ModelCode.TERMINAL_SEQNUM, typeof(PhaseCode));
