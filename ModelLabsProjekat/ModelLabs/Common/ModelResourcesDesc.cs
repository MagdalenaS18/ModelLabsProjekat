...
{	
	...
	public class ModelResourcesDesc
	{
		...
		{
			//Za konkretne klase, samo se ubace  po redosledu
			...
			typeIdsInInsertOrder.Add(ModelCode.REGULATIONSCHED);
		...
		{
			//reference te not setable ALI samo listereference odnoso 0,1 * 
			notSettablePropertyIds.Add(ModelCode.IDOBJ_GID);
			notSettablePropertyIds.Add(ModelCode.TERMINAL_REGULATINGCONTROL);
			notSettablePropertyIds.Add(ModelCode.REGULATINGCONTROL_REGULATINGCONDEQ);
			notSettablePropertyIds.Add(ModelCode.REGULATINGCONTROL_REGULATIONSCHED);
			notSettablePropertyIds.Add(ModelCode.DAYTYPE_SEASONDAYTYPESCHEDS);
			notSettablePropertyIds.Add(ModelCode.SEASON_SEASONDAYTYPESCHEDS);
