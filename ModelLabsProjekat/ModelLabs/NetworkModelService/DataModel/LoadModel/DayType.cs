...
namespace FTN.Services.NetworkModelService.DataModel.LoadModel
{
    public class DayType : IdentifiedObject
    {
        ...
        public override bool HasProperty(ModelCode t)
        {
            switch (t)
            {
                case ModelCode.DAYTYPE_SEASONDAYTYPESCHEDS:
                    return true;
        ...
        public override void GetReferences(Dictionary<ModelCode, List<long>> references, TypeOfReference refType)
        {
            ...
            {
                references[ModelCode.DAYTYPE_SEASONDAYTYPESCHEDS] = seasonDayTypeSchedules.GetRange(0, seasonDayTypeSchedules.Count);
            }
