...
namespace FTN.Services.NetworkModelService.DataModel.IES_Projects
{
    public class BasicIntervalSchedule : IdentifiedObject
    {
        ...
        public override bool HasProperty(ModelCode property)
        {
            switch (property)
            {
                case ModelCode.BASICINTERVALSCHED_STARTTIME:
                case ModelCode.BASICINTERVALSCHED_VAL1MUL:
                case ModelCode.BASICINTERVALSCHED_VAL1UNIT:
                case ModelCode.BASICINTERVALSCHED_VAL2MUL:
                case ModelCode.BASICINTERVALSCHED_VAL2UNIT:
