...
namespace FTN.ESI.SIMES.CIM.CIMAdapter.Importer
{
	...
	public class PowerTransformerImporter
	{
		...
		private void ConvertModelAndPopulateDelta()
		{
            ...
            // samo konkretne klase se importuju i bitan redosled zbog referenci
            // dms tipovi zadati redoledom kako je ovo importovano
            ImportTerminal();
		...
		private ResourceDescription CreateRegulationScheduleResourceDescription(FTN.RegulationSchedule cimRegulationSchedule)
		{
			...
			{
				long gid = ModelCodeHelper.CreateGlobalId(0, (short)DMSType.REGULATIONSCHED, importHelper.CheckOutIndexForDMSType(DMSType.REGULATIONSCHED));
				rd = new ResourceDescription(gid);
		...
		private void ImportAsynchronousMachine()
		{
			...
			{
				foreach (KeyValuePair<string, object> cimAsynchronousMachinePair in cimAsynchronousMachines)
				{
					FTN.AsynchronousMachine cimAsynchronousMachine = cimAsynchronousMachinePair.Value as FTN.AsynchronousMachine;
