	...
	public static class PowerTransformerConverter
	{
		...
		public static void PopulateRegulatingControlProperties(FTN.RegulatingControl cimRegulatingControl, ResourceDescription rd, ImportHelper importHelper, TransformAndLoadReport report)
		{
			if ((cimRegulatingControl != null) && (rd != null))
			{
				...
				{
					rd.AddProperty(new Property(ModelCode.REGULATINGCONTROL_MONPHASE, (short)cimRegulatingControl.MonitoredPhase));
				}
				if (cimRegulatingControl.TargetRangeHasValue)
				{
					rd.AddProperty(new Property(ModelCode.REGULATINGCONTROL_TARRANGE, cimRegulatingControl.TargetRange));
				}
				if (cimRegulatingControl.TargetValueHasValue)
				{
					rd.AddProperty(new Property(ModelCode.REGULATINGCONTROL_TARVALUE, cimRegulatingControl.TargetValue));
				}
				if (cimRegulatingControl.TerminalHasValue)
				{
					...
					if (gid < 0)
					{
						...
						report.Report.Append("\" - Failed to set reference to RegulatingControl: rdfID \"").Append(cimRegulatingControl.Terminal.ID).AppendLine(" \" is not mapped to GID!");
					}
		...
		public static void PopulateEquipmentProperties(FTN.Equipment cimEquipment, ResourceDescription rd)
		{
			if ((cimEquipment != null) && (rd != null))
			{
				...
				{
					rd.AddProperty(new Property(ModelCode.EQUIPMENT_AGGREGATED, cimEquipment.Aggregate));
				}
		...
		public static void PopulateBasicIntervalScheduleProperties(FTN.BasicIntervalSchedule cimBasicIntervalSchedule, ResourceDescription rd)
		{
			if ((cimBasicIntervalSchedule != null) && (rd != null))
			{
				...
				{
					rd.AddProperty(new Property(ModelCode.BASICINTERVALSCHED_STARTTIME, cimBasicIntervalSchedule.StartTime));
				}
				if (cimBasicIntervalSchedule.Value1MultiplierHasValue)
				{
					rd.AddProperty(new Property(ModelCode.BASICINTERVALSCHED_VAL1MUL, (short)cimBasicIntervalSchedule.Value1Multiplier));
				}
				if (cimBasicIntervalSchedule.Value1UnitHasValue)
				{
					rd.AddProperty(new Property(ModelCode.BASICINTERVALSCHED_VAL1UNIT, (short)cimBasicIntervalSchedule.Value1Unit));
				}
				if (cimBasicIntervalSchedule.Value2MultiplierHasValue)
				{
					rd.AddProperty(new Property(ModelCode.BASICINTERVALSCHED_VAL2MUL, (short)cimBasicIntervalSchedule.Value2Multiplier));
				}
				if (cimBasicIntervalSchedule.Value2UnitHasValue)
				{
					rd.AddProperty(new Property(ModelCode.BASICINTERVALSCHED_VAL2UNIT, (short)cimBasicIntervalSchedule.Value2Unit));
				}
			}
		}
		...
		public static void PopulateSeasonDayTypeScheduleProperties(FTN.SeasonDayTypeSchedule cimSeasonDayTypeSchedule, ResourceDescription rd, ImportHelper importHelper, TransformAndLoadReport report)
		{
			if ((cimSeasonDayTypeSchedule != null) && (rd != null))
			{
				...
				if (cimSeasonDayTypeSchedule.DayTypeHasValue)
				{
					...
					rd.AddProperty(new Property(ModelCode.SEASONDAYTYPESCHED_DAYTYPE, gid));
				}
				if (cimSeasonDayTypeSchedule.SeasonHasValue)
				{
					...
					rd.AddProperty(new Property(ModelCode.SEASONDAYTYPESCHED_SEASON, gid));
				}
			}
		}
		...
		public static void PopulateRegulationScheduleProperties(FTN.RegulationSchedule cimRegulationSchedule, ResourceDescription rd, ImportHelper importHelper, TransformAndLoadReport report)
		{
			if ((cimRegulationSchedule != null) && (rd != null))
			{
				...
				if (cimRegulationSchedule.RegulatingControlHasValue)
				{
					...
					rd.AddProperty(new Property(ModelCode.REGULATIONSCHED_REGCONTROL, gid));
				}
			}
		}
			...
			if ((cimRegulatingCondEq != null) && (rd != null))
			{
				...
				if (cimRegulatingCondEq.RegulatingControlHasValue)
				{
					...
					if (gid < 0)
					{
						...
						report.Report.Append("\" - Failed to set reference to RegulatingCondEq: rdfID \"").Append(cimRegulatingCondEq.RegulatingControl.ID).AppendLine(" \" is not mapped to GID!");
					}
					rd.AddProperty(new Property(ModelCode.REGULATINGCONDEQP_REGCONTROL, gid));
				}
			}
		}
		...
		public static void PopulateRotatingMachineProperties(FTN.RotatingMachine cimRotatingMachine, ResourceDescription rd, ImportHelper importHelper, TransformAndLoadReport report)
		{
			if ((cimRotatingMachine != null) && (rd != null))
			{
				...
				{
					rd.AddProperty(new Property(ModelCode.ROTATINGMACHINE_STATLEAKREAC, cimRotatingMachine.StatorLeakageReactance));
				}
				if (cimRotatingMachine.StatorResistanceHasValue)
				{
					rd.AddProperty(new Property(ModelCode.ROTATINGMACHINE_STATRESIS, cimRotatingMachine.StatorResistance));
				}
			}
		}
		...
		public static void PopulateAsynchronousMachineProperties(FTN.AsynchronousMachine cimAsynchronousMachine, ResourceDescription rd, ImportHelper importHelper, TransformAndLoadReport report)
		{
			if ((cimAsynchronousMachine != null) && (rd != null))
			{
				...
				if (cimAsynchronousMachine.Rr1HasValue)
				{
					rd.AddProperty(new Property(ModelCode.ASYNCMACHINE_RR1, cimAsynchronousMachine.Rr1));
				}
				if (cimAsynchronousMachine.Rr2HasValue)
				{
					rd.AddProperty(new Property(ModelCode.ASYNCMACHINE_RR2, cimAsynchronousMachine.Rr2));
				}
				if (cimAsynchronousMachine.TpoHasValue)
				{
					rd.AddProperty(new Property(ModelCode.ASYNCMACHINE_TPO, cimAsynchronousMachine.Tpo));
				}
				if (cimAsynchronousMachine.TppoHasValue)
				{
					rd.AddProperty(new Property(ModelCode.ASYNCMACHINE_TPPO, cimAsynchronousMachine.Tppo));
				}
				if (cimAsynchronousMachine.Xlr1HasValue)
				{
					rd.AddProperty(new Property(ModelCode.ASYNCMACHINE_XLR1, cimAsynchronousMachine.Xlr1));
				}
				if (cimAsynchronousMachine.Xlr2HasValue)
				{
					rd.AddProperty(new Property(ModelCode.ASYNCMACHINE_XLR2, cimAsynchronousMachine.Xlr2));
				}
				if (cimAsynchronousMachine.XmHasValue)
				{
					rd.AddProperty(new Property(ModelCode.ASYNCMACHINE_XM, cimAsynchronousMachine.Xm));
				}
				if (cimAsynchronousMachine.XpHasValue)
				{
					rd.AddProperty(new Property(ModelCode.ASYNCMACHINE_XP, cimAsynchronousMachine.Xp));
				}
				if (cimAsynchronousMachine.XppHasValue)
				{
					rd.AddProperty(new Property(ModelCode.ASYNCMACHINE_XPP, cimAsynchronousMachine.Xpp));
				}
				if (cimAsynchronousMachine.XsHasValue)
				{
					rd.AddProperty(new Property(ModelCode.ASYNCMACHINE_XS, cimAsynchronousMachine.Xs));
				}
			}
		}
